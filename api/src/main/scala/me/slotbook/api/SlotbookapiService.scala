...
object SlotbookapiService  {
  val TOPIC_NAME = "greetings"
}

/**
  * The slotbook-api service interface.
  * <p>
  * This describes everything that Lagom needs to know about how to serve and
  * consume the SlotbookapiService.
  */
trait SlotbookapiService extends Service {
  ...
  override final def descriptor = {
    ...
    named("slotbook-api")
      ...
      .withTopics(
        topic(SlotbookapiService.TOPIC_NAME, greetingsTopic _)
